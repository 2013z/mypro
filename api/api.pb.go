...
type MyProto struct {
	Age                  string   `protobuf:"bytes,1,opt,name=Age,proto3" json:"asdasdas"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MyProto) Reset()         { *m = MyProto{} }
func (m *MyProto) String() string { return proto.CompactTextString(m) }
func (*MyProto) ProtoMessage()    {}
func (*MyProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{2}
}
func (m *MyProto) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MyProto) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MyProto.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MyProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MyProto.Merge(m, src)
}
func (m *MyProto) XXX_Size() int {
	return m.Size()
}
func (m *MyProto) XXX_DiscardUnknown() {
	xxx_messageInfo_MyProto.DiscardUnknown(m)
}

var xxx_messageInfo_MyProto proto.InternalMessageInfo

func init() {
	proto.RegisterType((*HelloReq)(nil), "demo.service.v1.HelloReq")
	proto.RegisterType((*HelloResp)(nil), "demo.service.v1.HelloResp")
	proto.RegisterType((*MyProto)(nil), "demo.service.v1.MyProto")
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *MyProto) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MyProto) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MyProto) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Age) > 0 {
		i -= len(m.Age)
		copy(dAtA[i:], m.Age)
		i = encodeVarintApi(dAtA, i, uint64(len(m.Age)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MyProto) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MyProto: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MyProto: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
